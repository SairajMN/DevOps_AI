...
exports.FALLBACK_CHAIN = exports.TASK_MODEL_MAP = exports.AI_MODELS = void 0;
exports.getModelById = getModelById;
exports.getAllModels = getAllModels;
exports.getModelsByTaskType = getModelsByTaskType;
exports.AI_MODELS = [
    {
        id: "deepseek-r1",
...
function getModelById(id) {
    return exports.AI_MODELS.find(m => m.id === id);
}
/**
 * Get all available models
 */
function getAllModels() {
    return exports.AI_MODELS;
}
/**
 * Get models by task type
 */
function getModelsByTaskType(taskType) {
    return exports.AI_MODELS.filter(m => m.taskTypes.includes(taskType));
}
